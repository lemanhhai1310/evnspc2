...
<div class="uk-container uk-container-large">
    ...
    <div class="uk-grid-divider common" uk-grid>
        <div class="uk-width-expand@m">
            ...
            <div class="hihi1">
                <div class="bgd1">
                    <div class="uk-grid-medium sdtc1 uk-flex-top uk-child-width-1-4@m uk-margin-large uk-flex-between" uk-grid>
                        <div>
                            <div class="uk-grid-medium uk-child-width-1-1 uk-grid-large hai" uk-grid>
                                ...
                                <div>
                                    <div class="uk-card card3 uk-card-primary gd tgd uk-card-body uk-position-relative" style="z-index: 10000">
                        ...
                        <div class="uk-flex-first@m">
                            <div class="uk-card card3 hai2 uk-card-primary uk-card-body uk-padding-small">
                                <h3 class="uk-card-title uk-text-uppercase">BAN KIỂM SOÁT</h3>
                            </div>
                        </div>

                        <div>
                            <div class="uk-grid-medium ban2 uk-child-width-1-1 uk-margin-top" uk-grid>
                                <div>
